...
public class PlaceViewActivity extends ListActivity implements LocationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        View footerView = ((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.footer_view,
				null, false);
		...
		footerView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (mLastLocationReading == null) {
					Toast.makeText(getApplicationContext(), R.string.place_could_not_be_acquired, Toast.LENGTH_SHORT).show();
	...
	protected void onResume() {
		...
		if (null != mLastLocationReading && ageInMilliseconds(mLastLocationReading) > FIVE_MINS ) {
	...
	public void addNewPlace(PlaceRecord place) {
		...
		if (place == null) {
			...
			Toast.makeText(getApplicationContext(), R.string.no_country_string, Toast.LENGTH_SHORT).show();
	...
	public void onLocationChanged(Location currentLocation) {
		...
		// current location.
		if (mLastLocationReading == null || ageInMilliseconds(currentLocation) < ageInMilliseconds
